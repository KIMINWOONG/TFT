...
<?php } ?>
			...
			<ul>
				...
				<li>
					...
					<div class="input_inner sel_stu" id="student_job_area" style="display:<?=$student_job_area_class?>;">
						...
						<label for="resident">전공의<span class="eng_title2">(Resident)</span></label>
						<h5>직군에 따라 회비 금액이 상이하게 책정됩니다.<span class="eng_title2">Membership fees vary by occupation.
	...
	<div id="register_form" class="form_01">
	    <div class="tbl_frm01 tbl_wrap register_form_inner">
	        <ul>
	            <li class="align">
	                <label for=""><span class="required_mark">*</span>재직증명서<span class="eng_title">(Certificate of Employment)</span></label>
...
<button type="button" class="add-button" id="addFileButton" onclick="addFileInput()">+</button>
				...
				<li>
	                <label for="mb_school"><span class="required_mark">*</span>출신학교(학사)<span class="eng_title">(Undergraduate School)</span></label>
					<div class="input_inner number_input number_input2">
	      				<select name="mb_school" id="mb_school" class="custom-select" required>
                            <option value="" disabled selected hidden>선택</option>
							<option value="경희대학교 치과대학" <?php echo ($member['mb_school']=='경희대학교 치과대학')?'selected':''; ?>>경희대학교 치과대학</option>
							<option value="서울대학교 치의학대학원" <?php echo ($member['mb_school']=='서울대학교 치의학대학원')?'selected':''; ?>>서울대학교 치의학대학원</option>
							<option value="연세대학교 치과대학" <?php echo ($member['mb_school']=='연세대학교 치과대학')?'selected':''; ?>>연세대학교 치과대학</option>
							...
							<option value="경북대학교 치과대학" <?php echo ($member['mb_school']=='경북대학교 치과대학')?'selected':''; ?>>경북대학교 치과대학</option>
							<option value="부산대학교 치의학전문대학원" <?php echo ($member['mb_school']=='부산대학교 치의학전문대학원')?'selected':''; ?>>부산대학교 치의학전문대학원</option>
							<option value="전남대학교 치의학전문대학원" <?php echo ($member['mb_school']=='전남대학교 치의학전문대학원')?'selected':''; ?>>전남대학교 치의학전문대학원</option>
							<option value="조선대학교 치과대학" <?php echo ($member['mb_school']=='조선대학교 치과대학')?'selected':''; ?>>조선대학교 치과대학</option>
							<option value="원광대학교 치과대학" <?php echo ($member['mb_school']=='원광대학교 치과대학')?'selected':''; ?>>원광대학교 치과대학</option>
							<option value="전북대학교 치과대학" <?php echo ($member['mb_school']=='전북대학교 치과대학')?'selected':''; ?>>전북대학교 치과대학</option>
						</select>
					</div>
	            </li>
  ...
  <div class="input_inner number_input number_input2">
    ...
    <input type="text" name="mb_major_etc" id="mb_major_etc" value="<?php echo get_text($member['mb_major_etc']) ?>" placeholder="기타" disabled>
				...
				<li>
	                <label for="mb_branch"><span class="required_mark">*</span>분과<span class="eng_title">(Specialty)</span></label>
					<div class="input_inner number_input number_input2">
				...
				<li>
	                <label for="mb_school_etc"><span class="required_mark">*</span>기타학교(학사)<span class="eng_title">(Other Undergraduate School)</span></label>
					<div class="input_inner number_input number_input2">
	      				<select name="mb_school_etc" class="custom-select" id="mb_school_etc">
                            <option value="" disabled selected hidden>선택</option>
	    ...
	    <div class="tbl_frm01 tbl_wrap register_form_inner">
	        <ul>
	            ...
	            <li class="chk_box">
                    ...
                    <span class="eng_title">(I agree to receive email updates from the Korean Academy of Oral Implantology.<br>  You can opt out at any time, but will no longer receive emails from the Academy.)</span></h6>
				...
				<li class="chk_box">
					...
					<div class="input_inner">
						<h6>대한치과이식임플란트학회에서 발생하는 SMS를 수신합니다.<br> 수신 거부가 가능하며, 거부 시 학회에서 발송하는 SMS를 수신할 수 없습니다. <span class="eng_title">(I agree to receive SMS messages from the Korean Academy of Oral Implantology. <br> You may opt out, but will not receive any SMS from the Academy.)</span></h6>
...
document.addEventListener('DOMContentLoaded', function () {
    const selects = ['mb_school', 'mb_school_etc', 'mb_major', 'mb_branch'];
    const etcInput = document.getElementById('mb_major_etc');
