    ...
    <section id="bo_v_atc">
        ...
        <?php if($view['wr_link1']){?>
          ...
          <div class="video-wrap">
             <iframe id="video" width="100%" height="315" src="https://www.youtube.com/embed/<?=$view['wr_link1']?>" frameborder="0" allow="encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
       <?php }?>
