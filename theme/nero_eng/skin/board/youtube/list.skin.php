...
<div id="bo_gall"  class="width common">
	...
	<div class="you_big">
		...
		<iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?=$list[0]['wr_link1']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
	</div>
		...
		<!-- } 게시판 카테고리 끝 -->
			...
			<div class="you_wrap">
				...
				<div class="you_box" data-value="<?=$list[$i]['wr_link1']?>">
					<div class="you_thum">
						<img src="https://img.youtube.com/vi/<?=$list[$i]['wr_link1']?>/mqdefault.jpg" alt="">
					...
					<div class="you_text_wrap">
						...
						<div class="you_text3">
							...
							<a href="javascript:void(0)" class="youtube_view">간편보기</a>
							<a href="<?php echo $list[$i]['href'] ?>" class="youtube_view">게시글 보기</a>
							<a href="https://www.youtube.com/watch?v=<?=$list[$i]['wr_link1']?>" target=_blank>유튜브</a>
						</div>
					</div>
				</div>
				<?php } ?>
...
$(function(){
	...
	$(".you_box .you_thum,.you_box .youtube_view").on("click", function(){
		youtube_code=$(this).closest(".you_box").data("value");
		console.log("https://www.youtube.com/embed/"+youtube_code);
		$(".you_big iframe").attr("src","https://www.youtube.com/embed/"+youtube_code+"?rel=0&autoplay=1");
