    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div class="gall_img" style="<?php if ($board['bo_gallery_height'] > 0) echo '
                    ...
                    <div class="gall_text_href">
                      <div class="gall_href_effect">
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                         ...
                         <!-- <span class="bo_cnt"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 50, '..'); ?></span> -->
                         <span class="gall_pintro"><a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['wr_3']?$list[$i]['wr_3']:"-"; ?></a></span>
                      </a>
                    </div>
