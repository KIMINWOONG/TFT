  ...
  <li><a href="<?php echo $list_href ?>" class="btn_b01 btn" title="목록"><span class="view_btn">목록</span></a></li>
    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
            ...
            <li><span class="pro_call"><i data-feather="phone"></i></span><p><?php echo $view['wr_1']?$view['wr_1']:"-"; ?></p></li>
      		</ul>
...
;
	...
	?>
     ...
     <a href="<?php echo $list_href ?>" class="list_btn" title="목록"><span class="view_btn">목록</span></a>
</article>
<!-- } 게시판 읽기 끝 -->
