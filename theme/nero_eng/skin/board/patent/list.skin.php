...
<?php
    $sql = "SELECT * FROM g5_board_file WHERE bo_table = '${bo_table}' AND bf_no = 0 ORDER BY wr_id DESC";
...
<div id="bo_gall" style="width:<?php echo $width; ?>" class="width common">
  ...
  <div class="stitle wow fadeInup"  data-wow-duration="1s">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_text_href">
                      <div class="admin_btn">
                        ...
                        <a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?>
                        </a>
                        <?php } ?>
                        <?php if($is_admin){ ?>
                          <a href="<?php echo $list[$i]['href'] ?>" class="admin_re">수정하기</a>
                        <?php }?>
                      </div>
                          <a>
    ...
    <script>
        $(".gall_con").on("click", function(){
            let imgct = $(this).find(".pop_box");
                if(imgct.hasClass("open_pop") !== "true"){
                    imgct.addClass("open_pop");
                }
        })
        $("body").on("click", function(e){
            if(e.target.className.indexOf("open_pop") != -1 || e.target.className.indexOf("close_btn") != -1){
                $(".open_pop").removeClass("open_pop");
            }
        })
    </script>
    <!-- 페이지 -->
...
//     for(let i = 0; i < $('.gall_con').length; i++){
//         if($('.gall_con').eq(i).find(".img_pop").css("display") === "block"){
//             $('.gall_con').eq(i).find(".img_pop").css("display", "none");
//         }
//     }
// })
