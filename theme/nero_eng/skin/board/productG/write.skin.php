...
<section id="bo_w" class="width common">
    ...
    <div class="write_wrap">
      ...
      <?php }?>
      <div class="write_box required">
        <label for="wr_subject" class="bwcon_title">제품명</label>
        <div class="write_content">
          <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="" size="50" maxlength="255" placeholder="제품명">
    ...
    <div class="write_wrap">
      <div class="write_box">
        <label for="" class="bwcon_title">사이즈</label>
        <div class="write_content"><input type="text" name="wr_1" id="wr_1" value="<?php echo $write['wr_1']?>" placeholder="사이즈"></div>
      </div>
      <div class="write_box">
        <label for="" class="bwcon_title">제품특징</label>
        <div class="write_content"><input type="text" name="wr_2" id="wr_2" value="<?php echo $write['wr_2']?>" placeholder="제품특징"></div>
      </div>
      <div class="write_box">
        <label for="" class="bwcon_title">제품소개</label>
        <div class="write_content"><input type="text" name="wr_3" id="wr_3" value="<?php echo $write['wr_3']?>" placeholder="제품소개"></div>
      </div>
      <div class="write_box">
        <label for="" class="bwcon_title">제품기능</label>
        <div class="write_content"><input type="text" name="wr_4" id="wr_4" value="<?php echo $write['wr_4']?>" placeholder="제품기능"></div>
      </div>
      <div class="write_box">
        <label for="" class="bwcon_title">제품색상</label>
        <div class="write_content"><input type="text" name="wr_5" id="wr_5" value="<?php echo $write['wr_5']?>" placeholder="제품색상"></div>
      </div>
    </div>

    <div class="write_wrap">
      <label for="" class="bwcon_title prdt_cont">제품상세<a>*</a>  <span>[관리자]-[게시판 기능 설정]-[DHTML 에디터 사용 체크]</span></label>
