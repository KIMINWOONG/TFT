...
<div class="common event_2" id="event_point">
 ...
 <div class="event_menu">
    <ul class="event_02_2">
        ...
        <li class="event_on"><a href="<?php echo G5_THEME_URL ?>/subpage/event/event2_08.php#event_point">등록 신청 확인</a></li>
    </ul>
 </div>
...
?>
 <div class="content_wrap">
   <h4 class="sub_title2">대회 등록 신청 목록 <span class="scroll_768">* 좌우로 스크롤 해주세요.</span></h4>
