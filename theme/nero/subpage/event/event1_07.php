...
if($registration){
	alert("신청한 내역이 있습니다.", G5_THEME_URL."/subpage/event/event1_08.php");
}
...
<div class="common event_2" id="event_point">
 ...
 <div class="event_menu">
    <ul class="event_02_2">
        ...
        <li class="event_on"><a href="<?php echo G5_THEME_URL ?>/subpage/event/event1_07.php#event_point">사전등록 신청</a></li>
        <li><a href="<?php echo G5_THEME_URL ?>/subpage/event/event1_08.php#event_point">등록 신청 확인</a></li>
    </ul>
 </div>

 <div class="submission_form">
      <form id="ordform" name="ordform" action="event1_07_update.php" method="post" onsubmit="return ordform_submit(this);">
...
등록비 결제 관련 문의는 <span>smin5@snu.ac.kr</span>로 부탁드립니다.</p>
                        </td>
                    </tr>
...
let paymentDataConfig = {
    "공통": {
        ...
        "successUrl": g5_url + "/theme/nero/subpage/event/event1_07_success.php",
