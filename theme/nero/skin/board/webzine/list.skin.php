    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                  <div class="gall_con_text">
                    <div class="gall_info">
                      <span class="gall_day"><?php echo date("d", strtotime($list[$i]['wr_datetime'])) ?></span>
                      <span class="gall_year"><?php echo date("Y.m", strtotime($list[$i]['wr_datetime'])) ?></span>
                    </div>
                    <div class="gall_text_href">
                      <div class="bo_tit_info">
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                         ...
                         <a href="<?php echo $list[$i]['href'] ?>" class="bo_cnt"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 200, '..'); ?></a>
                    </div>
                  </div>
                    <div class="gall_img">
