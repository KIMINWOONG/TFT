...
<div id="bo_list" style="width:<?php echo $width; ?>" class="width common event_2">
 ...
 <div class="event_menu">
    <ul class="event_02">
        ...
        <li class="event_on"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=event_01#bo_list">공지</a></li>
    </ul>
 </div>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" style="width:78%;">제목</th>
            <!-- <th scope="col">글쓴이</th> -->
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
            ...
            <td class="td_subject" style="width:78%;">
                <?php
