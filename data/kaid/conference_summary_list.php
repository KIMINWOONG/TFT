...
<form name="flist" id="flist" action="./conference_summary_list_update.php" onsubmit="return flist_submit(this);" method="post">
        ...
        <table>
            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    $view_link = '<a href="./conference_summary_view.php?as_id='.$row['as_id'].'&'.$qstr.'" class="btn btn_03 btn_xs">상세</a>';
