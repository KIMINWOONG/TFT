...
<form name="flist" id="flist" action="./conference_registration_list_update.php" onsubmit="return flist_submit(this);" method="post">
        ...
        <table>
            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    $view_link = '<a href="./symposium_registration_form.php?cr_id='.$row['cr_id'].'&'.$qstr.'" class="btn btn_03 btn_xs">상세</a>';
                ...
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td class="td_left">
                        ...
                        <div class="registration_detail">
                            학술대회: <?=$row['sy_sdate']."~".$row['sy_edate']?>
                        </div>
                    </td>
                    <td class="td_left">
    ...
    <div class="btn_confirm01 btn_confirm">
        ...
        <?php } ?>
        <a href="./registration_excel_export_xlsx.php?<?php echo $qstr ?>&type=symposium" class="btn_03 btn">엑셀 다운로드</a>
    </div>
</form>
