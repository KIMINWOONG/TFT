...
<form name="inputform" id="inputform" action="./symposium_form_update.php" onsubmit="return inputform_submit(this)" method="post" enctype="multipart/form-data">
...
<div class="tbl_frm01 tbl_wrap conference_form">
    ...
    <tbody>
        <!-- 기본 정보 -->
        <tr>
            <th scope="row"><label for="sy_title">학술대회 제목<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="sy_title_en">학술대회 제목(영문)<strong class="sound_only">필수</strong></label></th>
            <td>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <input type="text" name="sy_place" value="<?php echo get_text($conference['sy_place']); ?>" id="sy_place" required class="frm_input required" size="90" maxlength="500" placeholder="학술대회 개최 장소">
                </td>
            </tr>
            <tr>
                <th scope="row"><label for="sy_address">주소<strong class="sound_only">필수</strong></label></th>
                <td>
                    <input type="text" name="sy_address" value="<?php echo get_text($conference['sy_address']); ?>" id="sy_address" required class="frm_input required" size="90" maxlength="500" placeholder="학술대회 개최 장소 주소">
                </td>
            </tr>
...
<div class="form_section">
    ...
    <tbody>
        <!-- 기본 정보 -->
        <tr>
            <th scope="row"><label for="sy_nonmember_enter">비회원 학술대회 참가가능 여부<strong class="sound_only">필수</strong></label></th>
            <td>
...
<div class="btn_confirm01 btn_confirm">
    <a href="./symposium_list.php" class="btn btn_02">목록</a>
    <?php if ($w == 'u') { ?>
    <a href="./symposium_schedule.php?sy_id=<?php echo $sy_id; ?>" class="btn btn_03">일정 관리</a>
    <a href="./symposium_speaker.php?sy_id=<?php echo $sy_id; ?>" class="btn btn_03">연자 관리</a>
    <?php } ?>
