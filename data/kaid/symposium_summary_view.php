...
<div class="abstract_view">
    ...
    <div class="view_section">
        ...
        <div class="section_body">
            <form id="statusForm" method="post" action="./symposium_summary_status_update.php">
    ...
    <div class="view_section">
        ...
        <div class="section_body">
            <div class="file_download">
                ...
                <a href="./symposium_summary_download.php?as_id=<?=$as_id?>" class="btn btn_03" style="margin-top: 10px;">파일 다운로드</a>
            </div>
        </div>
    </div>
    <?php } ?>
...
-->
    ...
    <!-- 하단 버튼 -->
    <div class="btn_group">
        <a href="./symposium_summary_list.php" class="btn btn_02">목록으로</a>
        <!--<a href="./abstract_print.php?as_id=<?=$as_id?>" class="btn btn_03" target="_blank">인쇄용 보기</a>-->
        <?php if ($abstract['as_file_path']) { ?>
        <a href="./symposium_summary_download.php?as_id=<?=$as_id?>" class="btn btn_03">파일 다운로드</a>
        <?php } ?>
    </div>
</div>
