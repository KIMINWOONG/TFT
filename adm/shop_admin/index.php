...
<div class="sidx sidx_cs" style="padding-left: 20px">
    <section id="anc_sidx_oneq" >
        <h2 class="h2_frm">1:1문의</h2>
        <?php echo $pg_anchor; ?>
