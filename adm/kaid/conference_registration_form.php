...
<div class="registration_view">
    ...
    <div class="view_header">
        <div>
            <div class="view_title">집담회 신청자 상세보기 #<?=$cr_id?></div>
            <div class="view_info">
    ...
    <!-- 학술집담회 정보 -->
    <div class="view_section">
        <div class="section_header">학술집담회 정보</div>
        <div class="section_body">
            <table class="info_table">
                <tr>
                    <th>집담회명</th>
    ...
    <!-- 결제 정보 -->
    <div class="view_section">
	<form name="paymentform" method="post" action="conference_registration_payment_update.php" target="hidfrm">
	<input type="hidden" name="cr_id" value="<?=$cr_id?>">
