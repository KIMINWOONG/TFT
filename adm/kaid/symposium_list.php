...
<form name="flist" id="flist" action="./symposium_list_update.php" onsubmit="return flist_submit(this);" method="post">
        ...
        <table>
            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    $one_update = '<a href="./symposium_form.php?w=u&amp;sy_id=' . $row['sy_id'] . '&amp;' . $qstr . '" class="btn btn_03">수정</a>';
    ...
    <div class="btn_confirm01 btn_confirm">
        <?php if ($is_admin == 'super') { ?>
            ...
            <a href="./symposium_form.php" id="bo_add" class="btn_01 btn">학술대회 추가</a>
        <?php } ?>
    </div>
