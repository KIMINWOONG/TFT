...
if ($stx) {
    $stx = trim($stx);
    $stx = addslashes($stx);
    $sql_search .= " AND co_name LIKE '%$stx%' ";
}
...
<fieldset>
    ...
    <label for="stx" class="sound_only">이름 검색<strong class="sound_only"> 필수</strong></label>
    <input type="text" name="stx" value="<?php echo $stx; ?>" id="stx" class="frm_input" placeholder="이름으로 검색">
